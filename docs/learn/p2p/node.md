...
:::success
However, if a validation node didn't receive enough a mining rewards during the month, the Network Pool (from the UCO distribution) will send compensation.
:::

For example: if a node receive $30 equivalent UCO, and if the rules say the minimum should be $50, then the network pool will send $20 to this node. If this node receives $100 of mining rewards, the network pool will node send any UCO to this node.  
